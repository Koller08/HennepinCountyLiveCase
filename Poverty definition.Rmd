...
df_2019['ppl_per_household'] <- ceiling(df_2019['pop_ffiec'] /
                                          df_2019['household_size'])
...
for (i in 1:nrow(df_2019)){
  ...
  income <- as.numeric(df_2019[i,'median_income_ethnicity'])
  limit <- as.numeric(df_2019[i,'monthly_income_limit'])
...
df_2019['pop_limit_by_ethnicity_income'] <- round(df_2019['pop_ffiec'] *
                                     df_2019['pop_perc_by_ethnicity_income'],0)
df_2019['snap_perc_by_ethnicity_income'] <- round(df_2019['people'] /
                                    df_2019['pop_limit_by_ethnicity_income'],2)
